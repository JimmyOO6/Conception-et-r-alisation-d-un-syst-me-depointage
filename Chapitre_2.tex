...
\begin{longtable}{|c|c|c|c|}
    ...
    % body of table
     ...
     \\
     \cline{1-3}
     14 & \multicolumn{2}{c|} {Consulter résumé de mon équipe} &
     \\
     \cline{1-3}
     15 & \multicolumn{2}{c|} {Consulter résumé de pointage des collaborateurs} &
     \\
     \cline{1-3}
     ...
     \\
     \cline{1-3}
     20 & \multicolumn{2}{c|} {Consulter résumé d’une équipe} & 
     \\
     \cline{1-3}
     ...
     \cline{1-3}
     25 & \multicolumn{2}{c|} {Consulter résumé de pointage des employés} & \\
     \cline{1-3}
     ...
     \hline
     34 & \multicolumn{2}{c|} {S'authentifier} 	 & 	\multirow{1}{*}{Administrateur}
     \\
     \hline
...
\subsection{Diagramme de cas d'utilisation du responsable}
    \begin{figure}[h!]
         \centering
         \includegraphics[width=17.5cm,height=21cm]{images/uc_responsable.png}
